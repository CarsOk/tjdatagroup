...
--
-- Host: localhost    Database: tjdatagroup1
-- ------------------------------------------------------
...
CREATE TABLE `usuario` (
  ...
  `cod_ciudad` varchar(3) DEFAULT NULL,
  `direccion` varchar(50) DEFAULT NULL,
  `email` varchar(100) DEFAULT NULL,
  `telefono` int(11) DEFAULT NULL,
  `contrasena` varchar(32) DEFAULT NULL,
  `cod_tipo_identificacion` varchar(2) DEFAULT NULL,
...
-- Dump completed on 2022-04-28 12:22:30
